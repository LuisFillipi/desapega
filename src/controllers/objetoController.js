...
export const getAllObjetcUser = async(request, response) => {
    try {
        ...
        const selectSql = /*sql*/ `SELECT obj.objeto_id, obj.usuario_id, obj.nome,obj.categoria, obj.peso, obj.cor, obj.descricao, obj.preco
        ...
        GROUP BY obj.objeto_id, obj.usuario_id, obj.usuario_id, obj.nome, obj.descricao,obj.peso, obj.cor, obj.descricao`
